...
colors = ['#09c', '#90c']
# p1hp, p2dm p1dd
data = [curve(300.0, 30.0, 0.65), curve(300.0, 100.0, 0.9)]
...
canvas.pack(padx=20, pady=10, side=BOTTOM)
...
stretch = max(canvas.winfo_height(), 200)
...
graph.pack(padx=20, pady=10, side=BOTTOM)
for i in range(11):
